      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          ...
          <div className="bg-muted/50 p-4 rounded-lg my-6">
            <p className="font-semibold">PLEASE NOTE: IF YOU SUBSCRIBE TO THE SERVICES FOR A SUBSCRIPTION TERM, THEN YOUR SUBSCRIPTION AND THIS AGREEMENT WILL BE AUTOMATICALLY RENEWED FOR SUCCESSIVE BILLING PERIODS AT OUR THEN-CURRENT PRICING FOR SUCH SERVICES UNLESS YOU OPT OUT OF THE AUTO-RENEWAL IN ACCORDANCE WITH SECTION 8 BELOW.</p>
          </div>

          <div className="bg-muted/50 p-4 rounded-lg my-6">
            <p className="font-semibold">PLEASE NOTE: THAT SECTION 11.9 OF THIS AGREEMENT CONTAINS AN ARBITRATION AGREEMENT THAT REQUIRES MOST DISPUTES BETWEEN US TO BE RESOLVED ON AN INDIVIDUAL, NON-CLASS ACTION BASIS THROUGH BINDING AND FINAL ARBITRATION INSTEAD OF IN COURT. SEE SECTION 11.9 FOR MORE INFORMATION REGARDING THIS ARBITRATION CLAUSE AND HOW TO OPT OUT.</p>
          </div>
          ...
          <ul className="space-y-3">
            ...
            <li><strong>"Customer Data"</strong> means any data in electronic form that Customer or Users make available through the Platform or that is otherwise collected by Unstuck on behalf of Customer or its Users.</li>
            <li><strong>"Documentation"</strong> means Unstuck's user guides and other end user documentation for the Services made available by Unstuck to its customers.</li>
            <li><strong>"Free Services"</strong> means the Services that Unstuck makes available free of charge.</li>
            <li><strong>"Fees"</strong> means any fees payable for the Services under the Order Form.</li>
            <li><strong>"Force Majeure Event"</strong> means an event which is unforeseeable, beyond the control of the party affected, and cannot be remedied by the exercise of reasonable diligence, including without limitation: acts of God, acts of government, flood, fire, earthquakes, civil unrest, acts of terror, strikes, computer, telecommunications, Internet service provider or hosting facility failures or delays involving hardware, software or power systems not within Unstuck's possession or reasonable control, and denial of service attacks.</li>
            <li><strong>"Pricing Page"</strong> means the publicly available web page(s) where Unstuck publishes its list prices for Services, currently available at https://unstuck.gg/pricing.</li>
            <li><strong>"Service Plan"</strong> means the packaged subscription plan and associated features to which Customer subscribes.</li>
            <li><strong>"Services"</strong> means the services that Unstuck will provide to Customer under this Agreement as described in the applicable Order Form.</li>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">2. The Services</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">2.1 Services</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">2.2 Software</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">2.3 Unstuck Ownership</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">2.4 Customer Chosen Third-Party Products</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">2.5 Free Services</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">3. Customer Data</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">3.1 Customer Ownership</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">3.2 Authorization</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">3.3 Aggregate and De-Identified Data</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">3.4 Security</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">4. Restrictions, Responsibilities and Rights</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">4.1 Customer Restrictions</h3>
          <p>Customer shall not:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Modify, copy, display, republish or create derivative works based on the Services or Unstuck Materials</li>
            ...
            <li>Access or use the Platform or Services without the prior written consent of Unstuck if Customer is or becomes a direct competitor to Unstuck or its affiliates</li>
            <li>Share access, use, or information about the Platform or Services with a direct competitor of Unstuck</li>
            ...
            <li>Use the Services in compliance with all applicable local, state, national and foreign laws, treaties and regulations in connection with Customer's use of the Services</li>
          </ul>

          <h3 className="text-xl font-semibold mt-6 mb-3">4.2 Customer Responsibilities</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">4.3 Artificial Intelligence Features</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">5. Fees; Payment Terms</h2>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">6. Warranties</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">6.1 Mutual Warranty</h3>
          <p>
            Each party represents and warrants that it has the legal power and authority to enter into this Agreement.
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3">6.2 Disclaimer of Warranties</h3>
          <div className="bg-muted/50 p-4 rounded-lg my-6">
            <p className="font-semibold">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">6.3 Beta Services</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">7. Confidential Information</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">7.1 Definition of Confidential Information</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">8.1 Automatic Renewal; Cancellation</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">8.2 Termination for Material Breach</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">11. General Provisions</h2>
          
          <h3 className="text-xl font-semibold mt-6 mb-3">11.1 Relationship of the Parties</h3>
          <p>
            The parties are independent contractors. This Agreement does not create a partnership, franchise, joint venture, agency, fiduciary, or employment relationship between the parties.
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3">11.2 Notices</h3>
          <p>
