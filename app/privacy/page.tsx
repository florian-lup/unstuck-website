    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          <p>
            Your privacy is important to us. This Privacy Policy ("Policy") applies to services provided by Unstuck ("we", "us", or "Unstuck") and our website (the "Site"), product pages, mobile or web applications, or other digital products that link to or reference this Policy (collectively, the "Services") and explains what information we collect from users of our Services (a "user", "you", or "your"), including information that may be used to personally identify you ("Personal Information") and how we use it. We encourage you to read the details below. This Policy applies to any visitor to or user of our Services. Any capitalized terms used herein but not defined shall have the meaning set forth in our Terms of Service, available at https://unstuck.gg/terms.
          </p>
          ...
          <p>
            <strong>Account Information.</strong> To create an account for the Services or to enable certain features, we may require that you provide us with information for your account such as name, email, profile picture, password, and authentication credentials.
          </p>

          <p>
            <strong>Payment Information.</strong> If you sign up for a paid subscription, we (or our payment processors) may need your billing details such as credit card information, banking information, and billing address. Your payment information, such as your payment method (valid credit card number, type, expiration date or other financial information), is collected and stored by our third party payment processing company (the "Payment Processor") and use and storage of that information is governed by the Payment Processor's applicable privacy policy. As of the Effective Date of this Privacy Policy listed below, Stripe is the Payment Processor used within the Services and its privacy policy is available at https://stripe.com/us/privacy or such other URL designated by Stripe. In order to facilitate your order transactions, we collect and store your credit card type, the last four digits of your credit card number, and expiration date, but no other financial information.
          </p>

          <p>
            <strong>Game Data and Screenshots.</strong> In using our Services, our customers may submit or upload, or instruct Unstuck to collect, game screenshots, gameplay recordings, and/or seek customer support, or provide other Customer Data (defined in our Terms of Service) to us. Our use of and processing of Customer Data is governed by our Terms of Service or other services agreement with the Customer.
          </p>

          <p>
            <strong>Business Contact Information.</strong> If you are a business representative, we collect your information in connection with the performance of the agreement or potential agreement with us. This information may include your first name, last name, Unstuck contact information (e.g., email, phone, address), job title, and any other information related to the performance of the agreement with us.
          </p>

          <p>
            <strong>Other Information You Provide.</strong> We receive other information from you when you choose to interact with us in other ways, such as if you sign up for one of our newsletters, participate in a research study or event, or otherwise communicate with us.
          </p>
          ...
          <p>
            <strong>Log Data.</strong> Information that your browser automatically sends whenever you use our website ("log data"). Log data includes your internet protocol address, browser type and settings, the date and time of your request, and how you interacted with our website.
          </p>

          <p>
            <strong>Usage Data.</strong> We may automatically collect information about your use of the Services, such as the types of content that you view or engage with, the features you use and the actions you take, as well as your time zone, country, the dates and times of access, user agent and version, type of computer or mobile device, computer connection, IP address, and the like.
          </p>

          <p>
            <strong>Device Information.</strong> Includes name of the device, operating system, and browser you are using. Information collected may depend on the type of device you use and its settings.
          </p>

          <p>
            <strong>Analytics.</strong> We may use a variety of online analytics products that use cookies to help us analyze how users use our Services and enhance your experience when you use the Services.
          </p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">Information We Receive from Third Parties</h3>
          
          <p>
            <strong>Third-Party Authentication.</strong> If you sign up or login to our Services using one of our sign-on providers (e.g., Google, Discord, Steam, etc.), we collect authentication information provided to us by the provider to allow you to log in.
          </p>

          <p>
            <strong>Marketing Information.</strong> We may receive marketing or demographic information about you from third parties or partners, for example, data about your organization or industry or other public information from sources like social media or online professional profiles.
          </p>

          <p>
            <strong>Service Providers.</strong> We may receive information from our service providers, who help us operate our business.
          </p>

          <p>
            <strong>Information from Other Sources.</strong> We may obtain information from other sources, including, but not limited to, publicly available sources, third-party data providers, brand partnerships, and third-party integrations you consent to, or through transactions such as mergers and acquisitions. We may combine this information with other information we collect from or about you.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>To analyze how you use the Services with tools, such as analytics tools, to help us understand traffic patterns and know if there are problems with the Services</li>
            ...
            <li>To protect our users, other individual lives, and/or the rights or property of Unstuck</li>
          ...
          <p>In addition to the specific situations discussed elsewhere in this privacy policy, we disclose personal information in the following circumstances:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>With our corporate affiliates and subsidiaries</li>
            <li>With the applicable Customer to provide Services on their behalf. Our Customers are independent entities and their processing of information is subject to their own policies and terms</li>
            <li>With third parties that perform services to support our core business functions and internal operations, which may include:
            ...
            <li>If we have a good-faith belief that access, use, preservation, or disclosure of such information is reasonably necessary to detect, protect against or investigate fraud or security issues</li>
            <li>If required or permitted by applicable law or regulation, including laws and regulations of the United States and other countries, or in the good faith belief that such action is necessary to:
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>(a) comply with a legal obligation or in response to a request from law enforcement or other public authorities wherever Unstuck may do business</li>
                <li>(b) protect and defend the rights or property of Unstuck</li>
                <li>(c) act in urgent circumstances to protect the personal safety of users, customers, and contractors/employees of Unstuck or others</li>
                <li>(d) enforce our Terms of Service or otherwise protect against any legal liability</li>
              </ul>
            </li>
          ...
          <p>
            Some of the features on the Services may require the use of "cookies" - small text files that are stored on your device's hard drive. We use Cookies to enable our servers to recognize your web browser and tell us how and when you visit and use our Services, to remember your preferences, analyze trends, learn about our user base, provide relevant advertising, and operate and improve our Services. We may supplement the information we collect from you with information received from third parties, including information collected using third party cookies. You may delete and block all cookies from our Services, but parts of the Services may not work or your overall user experience may be diminished, since it will no longer be personalized to you. It may also prevent you from saving customized settings, like log-in information.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">How Do We Secure Your Personal Information?</h2>
          <p>
          ...
          <p>
            All users may request to review, update, correct or delete the Personal Information furnished by a user in their user account by contacting us at contact@unstuck.gg or by accessing your user account. For your protection, we may only share and update the Personal Information associated with the specific email address that you use to send us your request, and we may need to verify your identity before doing so. We will try to comply with such requests in a reasonably timely manner. If you completely and permanently delete all of your Personal Information, then your user account may become deactivated. If you wish to cancel your account, you may do so through your account page, and any personally identifiable information associated with your account will be deleted as soon as is reasonably practical or as required by applicable law.
          </p>

          <p>
            We may use some of the information we collect for marketing purposes, including to send you promotional communications about new Unstuck features, products, events, or other opportunities. If you wish to stop receiving these communications or to opt out of use of your information for these purposes, please follow the opt-out instructions, such as clicking "Unsubscribe" (or similar opt-out language) in those communications. You may also change your marketing email preferences via your account settings.
          </p>
          ...
          <p>
            If you believe that we have unknowingly collected any Personal Information from someone under the age of sixteen (16), please contact us immediately at contact@unstuck.gg and the information will be deleted.
          </p>
          ...
          <p>
            If you have any questions about this Policy, your Personal Information, or the Services, you can contact us at contact@unstuck.gg.
          </p>
        </div>
      </div>
    </div>
