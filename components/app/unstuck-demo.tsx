...
export function UnstuckApp() {
  const [activeTab, setActiveTab] = useState<
    "guides" | "builds" | "lore" | "troubleshooting" | null
  >(null);
    ...
    >
      ...
      {isChatOpen && (
        <>
          ...
          <div
            className="flex items-center justify-between px-2 py-1 rounded-full overflow-x-scroll scrollbar-none"
          ...
          {/* Main Content Area */}
          <div
            className="flex-1 overflow-y-auto px-4 py-6 rounded-xl scrollbar-none"
            style={{
            ...
            {showResponse ? (
              <>
                ...
                <div className="mb-4 px-4 py-2 rounded-md">
                  <p className="text-gray-300 text-sm">{submittedQuery}</p>
                </div>
                ...
                >
                  <div className="px-6">
                    <div className="space-y-6">
                      <p className="text-gray-200 text-base leading-relaxed">{trashTalkMessage}</p>
              ...
              <>
                ...
                <div className="mb-4 px-4 py-2 rounded-md">
                  <p className="text-gray-300 text-sm">How to defeat Dimensius on heroic?</p>
                </div>
                  ...
                  <div className="px-6">
                    <div className="space-y-4">
                      <p className="text-gray-200 text-sm leading-relaxed">
                        Let me guess—you stood in the void zones and blamed the healer, right?
                        Anyway, since you clearly can&apos;t figure this out yourself, here&apos;s
                        how to defeat{" "}
                        <span className="font-semibold text-white">
                          Dimensius the All-Devouring
                        </span>{" "}
                        on Heroic in{" "}
                        <span className="font-semibold text-white">World of Warcraft 11.2</span>{" "}
                        without wiping your raid (again).
                      </p>

                      <div>
                        <p className="text-white font-semibold text-sm mb-2">
                          The Basics (Since You Obviously Missed Them):
                        </p>
                        <ul className="space-y-2 text-gray-300 text-sm list-disc list-inside">
                          <li>
                            This is a multi-phase encounter. Yes, there&apos;s more than one phase.
                            Shocking, I know.
                          </li>
                          <li>
                            You&apos;ll need to actually pay attention to positioning, adds, and not
                            dying. Revolutionary concept.
                          </li>
                        </ul>
                      </div>
                        ...
                        <div className="space-y-3">
                          <div>
                            <p className="text-white font-medium text-sm mb-1">
                              Phase 1: Try Not to Mess This Up Immediately
                            </p>
                            <ul className="space-y-1 text-gray-300 text-sm list-disc list-inside ml-2">
                              <li>
                                Split your raid into two groups. I know teamwork is hard, but stay
                                with me here.
                              </li>
                              <li>
                                Kill the Living Mass adds. They&apos;re big and obvious—even you
                                should be able to target them.
                              </li>
                              <li>
                                Pick up the Excess Mass orbs. No, not EVERY orb. Just the ones
                                you&apos;re assigned. Meet in the center with your partner and drop
                                the puddle. It&apos;s not rocket science.
                              </li>
                              <li>
                                Don&apos;t stand behind the boss during the tank smash. Seriously,
                                just... don&apos;t.
                              </li>
                              <li>
                                When the group soak happens, actually soak it. Wild concept, I know.
                              </li>
                            </ul>
                          </div>
                          ...
                          <div>
                            <p className="text-white font-medium text-sm mb-1">
                              Platform Transition (AKA The Part Where Half Your Raid Falls Off):
                            </p>
                            <ul className="space-y-1 text-gray-300 text-sm list-disc list-inside ml-2">
                              <li>
                                Use your dragonriding skills to reach the next platform. Yes, the
                                same ones you use to AFK fly to the nearest mailbox.
                              </li>
                            </ul>
                          </div>
                          ...
                          <div>
                            <p className="text-white font-medium text-sm mb-1">
                              Phase 2: Add Control for People Who Can&apos;t Count
                            </p>
                            <ul className="space-y-1 text-gray-300 text-sm list-disc list-inside ml-2">
                              <li>
                                Kill Void Wardens and Nullbinders first. Not the boss. Not random
                                trash. These specific adds.
                              </li>
                              <li>
                                Nullbinders slow you down and hurt. Grip them together and cleave.
                                It&apos;s called efficiency—look it up.
                              </li>
                              <li>
                                You have limited time before the mini-boss enrages. If you fail this
                                twice, maybe heroic isn&apos;t for you?
                              </li>
                            </ul>
                          </div>
                          ...
                          <div>
                            <p className="text-white font-medium text-sm mb-1">
                              Final Phase (Where Your Raid Actually Falls Apart):
                            </p>
                            <ul className="space-y-1 text-gray-300 text-sm list-disc list-inside ml-2">
                              <li>
                                Pop Heroism/Bloodlust immediately. Yes, NOW. Not when the boss is at
                                1% and everyone&apos;s dead.
                              </li>
                              <li>
                                Hide inside the 8 stars when Dimensius casts Devour at 100 energy.
                                It&apos;s literally a game of hide-and-seek, and somehow you&apos;re
                                still losing.
                              </li>
                              <li>
                                After three Devours, you wipe. So maybe try killing the boss before
                                then? Just a thought.
                              </li>
                              <li>
                                Don&apos;t touch the boss&apos;s hitbox (instant death), don&apos;t
                                stand in used stars (they&apos;re black holes now), and dodge the
                                falling stars. How many things can you stand in before you learn?
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div>
                        <p className="text-white font-semibold text-sm mb-2">
                          Pro Tips (For When Basic Tips Aren&apos;t Enough):
                        </p>
                        <ul className="space-y-2 text-gray-300 text-sm list-disc list-inside">
                          <li>
                            Actually use your movement abilities. They&apos;re not just for show.
                          </li>
                          <li>
                            Healers: spam those instant casts. Your raid is going to need it with
                            all the avoidable damage they&apos;re taking.
                          </li>
                          <li>
                            Tanks: position the boss properly. If you wipe because you turned him
                            toward the raid, that&apos;s on you, chief.
                          </li>
                        </ul>
                      </div>

                      <p className="text-gray-300 text-sm leading-relaxed italic">
                        Still wiping? Maybe it&apos;s not the strategy—it&apos;s you. Want
                        class-specific advice? Too bad, this is a demo. 💀
                      </p>
                    </div>
                  </div>
                </Card>
          ...
          {/* Bottom Input Area */}
          <div className="px-1 py-1 rounded-full" style={{ backgroundColor: "rgba(0, 0, 0, 0.3)" }}>
